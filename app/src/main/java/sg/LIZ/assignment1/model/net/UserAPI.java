...
class UserAPI {
    ...
    public boolean registerUser(@NonNull CharSequence userName, @NonNull CharSequence password) throws IOException {
        ...
        out.write(new char[]{'&', 'p', 'a', 's', 's', 'w', 'o', 'r', 'd', '='}, 0, 10);
        out.append(URLEncoder.encode(password.toString(), charset));
        out.close();
